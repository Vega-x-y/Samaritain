...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le mot de passe a été divulgué lors d\'une fuite de données. Veuillez en choisir un différent.',
    ],
    ...
    */
    ...
    'custom' => [
        'email' => [
            'exists' => 'Cette adresse email n\'est pas associée à un compte.',
        ],
        'password' => [
