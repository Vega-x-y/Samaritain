    ...
    <x-blade-components::layout.container>
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                <div>
                    <h1 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">Mes hôtels</h1>
                    <p class="text-gray-500 dark:text-gray-400 mt-1 text-sm">Gérez vos hôtels en un clin d'œil</p>
                </div>
                <x-btn href="{{ route('hotel.create') }}" class="dark:bg-primary-600 dark:text-white dark:hover:bg-primary-700">
                    <x-slot:prefix>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 dark:text-gray-400 text-sm font-medium">Total des hôtels</p>
            ...
            <div class="rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Mes hôtels</h2>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Gérez et suivez l'état de vos annonces</p>
                        </div>
                        @if ($hotels->count() > 0)
                            <span class="text-sm text-gray-400 dark:text-gray-500">{{ $hotels->total() }} hôtel(s) au total</span>
                        @endif
                    </div>
                </div>
                                    ...
                                    <table class="w-full text-xs text-gray-600 dark:text-gray-300">
                                        <thead class="border-b border-b-gray-100 dark:border-b-gray-700">
                                            <tr>
                                                ...
                                                <th class="px-4 py-3 text-left">Prix/heure</th>
                                            ...
                                            @foreach ($hotels as $hotel)
                                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                                    ...
                                                    <td class="px-4 py-3 font-medium hover:text-blue-600 dark:hover:text-blue-400">
                                                        <a href="{{ route('hotel.show', $hotel) }}" class="text-gray-800 dark:text-white">{{ $hotel->title }}</a>
                                                    </td>
                                                    <td class="px-4 py-3 text-gray-800 dark:text-white">{{ number_format($hotel->price_per_hour, 0, ',', ' ') }} FCFA {{ $hotel->price_label }}</td>
                                                    <td class="px-4 py-3">
                                                    ...
                                                    <td class="px-4 py-3">
                                                        <div class="flex items-center justify-center gap-2">
                                                            ...
                                                            <form action="{{ route('hotel.duplicate', $hotel) }}"
                                                            ...
                                                            <button
                                                                x-on:click="openModal('{{ route('hotel.destroy', $hotel) }}', '{{ $hotel->title }}')"
                                        ...
                                        <div class="flex items-start gap-4">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">
                                                    Êtes-vous sûr de vouloir supprimer <strong x-text="hotelTitle" class="text-gray-800 dark:text-white"></strong> ?
            ...
            <div class="mt-8 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-xl p-5 border border-blue-100 dark:border-blue-900/30">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h3 class="font-semibold text-gray-900 dark:text-white mb-1">Conseils pour maximiser vos réservations</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-300">
                            Ajoutez des photos de qualité, une description détaillée et un prix compétitif.
                            Les hôtels vérifiés par notre équipe apparaissent en priorité dans les recherches.
                        </p>
                    </div>
                </div>
            </div>
