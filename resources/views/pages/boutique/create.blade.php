...
@section('title', 'Ajouter une boutique')
...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8 max-w-5xl">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Ajouter une boutique</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Remplissez tous les champs pour créer votre boutique</p>
            </div>
        ...
        <div class="bg-sidebar dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
            <form action="{{ route($routePrefix . '.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <x-form.textarea name="description" label="Description de la boutique" rows="6">{{ old('description') }}</x-form.textarea>
                </div>
                ...
                <!-- Images -->
                <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Images de la boutique</h2>
