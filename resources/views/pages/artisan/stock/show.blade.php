        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-100 dark:border-gray-700">
            ...
            <form method="POST" action="{{ route('artisan.stock.mouvement', $article) }}" class="space-y-4">
                ...
                <div>
                    ...
                    <x-form.select name="type" label="Type *" :options="['entree' => 'Entrée', 'sortie' => 'Sortie']" required />
                </div>
                ...
                <button type="submit" class="w-full bg-primary hover:bg-primary/90 text-white py-2.5 rounded-xl font-semibold transition">
