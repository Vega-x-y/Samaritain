...
<div class="container mx-auto px-4 py-8">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
            <h1 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">Ma <span class="text-primary">messagerie</span></h1>
                    ...
                    @forelse ($conversations as $conversation)
                        <div class="flex items-center group">
                            <a href="{{ route('artisan.messagerie.conversation', $conversation) }}" 
                                class="block flex-1 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition {{ $conversation->lu ? '' : 'bg-primary/10 dark:bg-primary/10' }}">
                                <div class="flex items-start gap-3">
                                    <div class="w-10 h-10 rounded-full bg-primary/10 dark:bg-primary/20 flex items-center justify-center text-sm font-bold text-primary dark:text-primary shrink-0">
