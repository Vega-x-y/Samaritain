...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        <h1 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">💬 Nouvelle <span class="text-orange-500">conversation</span></h1>
                    ...
                    <div>
                        ...
                        @if($clients->isEmpty())
                            <p class="text-amber-600 dark:text-amber-400 text-xs mt-2">
                                ...
                                <a href="{{ route('artisan.clients.create') }}" class="underline hover:text-orange-500">Créez d'abord un client</a> 
