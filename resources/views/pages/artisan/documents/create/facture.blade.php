                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="numero_facture" value="{{ old('numero_facture') }}" required
                               class="w-full rounded-lg border-border focus:border-orange-500 focus:ring-orange-500 bg-background text-sm @error('numero_facture') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="date" name="date_emission_facture" value="{{ old('date_emission_facture') }}" required
                               class="w-full rounded-lg border-border focus:border-orange-500 focus:ring-orange-500 bg-background text-sm @error('date_emission_facture') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="number" name="montant_ht" id="montant_ht" value="{{ old('montant_ht') }}"
                               ...
                               class="w-full rounded-lg border-border focus:border-orange-500 focus:ring-orange-500 bg-background text-sm @error('montant_ht') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="number" name="tva" id="tva" value="{{ old('tva', 0) }}"
                               step="0.01" min="0"
                               class="w-full rounded-lg border-border focus:border-orange-500 focus:ring-orange-500 bg-background text-sm @error('tva') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="number" name="montant_ttc" id="montant_ttc" value="{{ old('montant_ttc') }}"
                               ...
                               class="w-full rounded-lg border-border focus:border-orange-500 focus:ring-orange-500 bg-background text-sm @error('montant_ttc') border-red-500 @enderror">
