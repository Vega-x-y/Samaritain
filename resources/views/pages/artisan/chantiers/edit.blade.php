...
<div class="container mx-auto px-4 py-8">
    <!-- En-tête -->
    <div class="mb-8">
        <h1 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">�o�️ Modifier le <span class="text-primary">chantier</span></h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="priorite"
                                ...
                                <option value="haute" {{ old('priorite', $chantier->priorite) === 'haute' ? 'selected' : '' }}>�Y"� Haute</option>
                                <option value="moyenne" {{ old('priorite', $chantier->priorite) === 'moyenne' ? 'selected' : '' }}>�YY� Moyenne</option>
                                <option value="basse" {{ old('priorite', $chantier->priorite) === 'basse' ? 'selected' : '' }}>�YY� Basse</option>
                            </select>
