...
<div class="container mx-auto px-4 py-8">
    <!-- En-tête -->
    <div class="mb-8">
        <h1 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-white"><i data-lucide="wallet" class="w-4 h-4 inline-block align-middle mr-1"></i> Nouveau <span class="text-primary">client</span></h1>
    ...
    <div class="max-w-3xl">
        <form method="POST" action="{{ route('artisan.clients.store') }}" class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <x-form.select name="user_id" label="Client *" placeholder="Sélectionnez un client" :options="$users" optionValue="id" optionLabel="name" required />
                    </div>
            ...
            <div class="flex gap-3">
                <x-btn type="submit" size="lg" class="flex-1">
                    Créer le client
                </x-btn>
                <x-btn href="{{ route('artisan.clients.index') }}" style="outline" size="lg">
                    Annuler
                </x-btn>
            </div>
        </form>
