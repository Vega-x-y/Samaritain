...
<div class="container mx-auto px-4 py-8">
    <!-- En-tête -->
    <div class="mb-8">
        <h1 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">✏️ Modifier le <span class="text-orange-500">client</span></h1>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="4"
                            class="w-full px-4 py-2.5 border border-gray-200 dark:border-gray-600 rounded-lg focus:border-orange-500 focus:ring-2 focus:ring-orange-100 dark:focus:ring-orange-900 outline-none transition bg-white dark:bg-gray-700 text-gray-900 dark:text-white">{{ old('notes', $client->notes) }}</textarea>
