            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <x-form.select name="user_id" label="Client *" placeholder="Sélectionnez un client" :options="$users" optionValue="id" optionLabel="name" :value="$client->user_id" required />
                    </div>
                    ...
                    <div>
                        ...
                        <x-form.select name="type" label="Type *" :options="collect($types)->mapWithKeys(fn ($type) => [$type->value => $type->label()])" :value="$client->type->value" required />
                    </div>
