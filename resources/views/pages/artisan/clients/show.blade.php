...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-sidebar dark:bg-gray-800 rounded-xl p-5 border border-accent dark:border-gray-700">
            ...
            <div class="space-y-2 text-sm">
                ...
                <div class="flex justify-between">
                    ...
                    <a href="tel:{{ $client->telephone }}" class="font-medium text-orange-500 hover:text-orange-600 transition-colors">{{ $client->telephone }}</a>
                </div>
                @if ($client->email)
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-gray-400">Email</span>
                        <a href="mailto:{{ $client->email }}" class="font-medium text-orange-500 hover:text-orange-600 transition-colors truncate max-w-48">{{ $client->email }}</a>
                    </div>
                @endif
                @if ($client->adresse)
                    <div class="flex justify-between">
        ...
        @if ($client->notes)
        <div class="bg-sidebar dark:bg-gray-800 rounded-xl p-5 border border-accent dark:border-gray-700">
            <h3 class="text-xs uppercase font-semibold text-gray-400 dark:text-gray-500 mb-3 border-b border-gray-100 dark:border-gray-700 pb-2">📝 Notes</h3>
        ...
        <div class="bg-sidebar dark:bg-gray-800 rounded-xl p-5 border border-accent dark:border-gray-700 md:col-span-2">
            <h3 class="text-xs uppercase font-semibold text-gray-400 dark:text-gray-500 mb-3 border-b border-gray-100 dark:border-gray-700 pb-2">📋 Chantiers associés</h3>
    ...
    <div class="mt-8 flex flex-wrap gap-3">
        ...
        @endif
        <a href="{{ route('artisan.chantiers.index', ['client_id' => $client->id]) }}" class="bg-orange-500 hover:bg-orange-600 text-white px-5 py-2.5 rounded-full text-sm font-medium transition shadow-md hover:shadow-lg">
            📋 Voir ses chantiers
        </a>
    </div>
</div>
