...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2 text-sm">
                ...
                @if ($evenement->chantier)
                    <div class="flex justify-between">
                        ...
                        <a href="{{ route('artisan.chantiers.show', $evenement->chantier) }}" class="font-medium text-orange-500 hover:text-orange-600 transition-colors">
        ...
        <div class="bg-sidebar dark:bg-gray-800 rounded-xl p-5 border border-accent dark:border-gray-700">
            <h3 class="text-xs uppercase font-semibold text-gray-400 dark:text-gray-500 mb-3 border-b border-gray-100 dark:border-gray-700 pb-2">📝 Description</h3>
