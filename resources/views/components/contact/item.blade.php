...
<a
    ...
    {{ $attributes->merge(['class' => 'flex items-center gap-3 px-3 py-2 rounded-md hover:bg-muted/50 focus:bg-muted/50 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-ring']) }}
>
    <span class="flex-shrink-0 text-primary w-5 h-5" aria-hidden="true">
        {!! $iconSvg !!}
    </span>
