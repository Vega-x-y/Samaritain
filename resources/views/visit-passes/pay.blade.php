...
<div class="font-body bg-background dark:bg-gray-950 text-[#0F0E0C] dark:text-white antialiased min-h-screen">
    <div class="max-w-4xl mx-auto px-6 py-10 pb-20">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mb-8">Vous serez redirigé vers la page de paiement sécurisée pawaPay pour choisir votre opérateur et valider le paiement.</p>
        ...
        <form action="{{ route('my-visit-passes.initiate-payment', $visitPass) }}" method="POST">
            ...
            <div class="mt-6 flex flex-col sm:flex-row items-center gap-3">
                <button type="submit"
                    ...
                    Ouvrir la page de paiement ({{ number_format($visitPass->amount, 0, ',', ' ') }} {{ $currency }})
                </button>
